...
def workflow_EP(current_config_folder, verbose=True):
    ...
    species_input = parameters_workflow(
        current_config_folder+'/actor_settings.xml')
    scenario_params = parameters_workflow(
        current_config_folder+'/scenario.xml')
    ...
    for i in pulse_list:
        if len(pulse_list) == 1:
            ...
            save_xml_param_to_file_on_run(
                current_config_folder+'/input_workflow_default.xml', 'shot_nr', str(i[0]))
            update_xml_param_on_run(param, 'run_in', i[1])
            save_xml_param_to_file_on_run(
                current_config_folder+'/input_workflow_default.xml', 'run_in', str(i[1]))
            param = parameters_workflow(
                current_config_folder+'/input_workflow_default.xml')
        ...
        if int(param['ligka_541']) or int(param['ligka_5412']):
            ...
            if param_ligka['modus'] == 5:
                actor_call("Ligka_m5", current_config_folder,
                           param, species_input)
            ...
            if param_ligka['modus'] == 4:
                actor_call("Ligka_m4", current_config_folder,
                           param, species_input)
            ...
            if param_ligka['modus'] == 1:
                actor_call("Ligka_m1", current_config_folder,
                           param, species_input)
            ...
            if int(param['ligka_5412']):
                ...
                if param_ligka['modus'] == 2:
                    actor_call("Ligka_m2", current_config_folder,
                               param, species_input)
            ...
            if param['Stability_code'] == 'Ligka_m6':
                ...
                actor_call("Ligka_m6", current_config_folder,
                           param, species_input)
            ...
            if param['Stability_code'] == 'Ligka_m3':
                ...
                actor_call("Ligka_m3", current_config_folder,
                           param, species_input)
            ...
            if param['Distributions_1'] == 'Hagis_1':
                ...
                actor_call("Hagis_1", current_config_folder,
                           param, species_input)

            if param['Distributions_2'] == 'Hagis_2':

                actor_call("Hagis_2", current_config_folder,
                           param, species_input)
            ...
            if param['Orbit_Finder'] == 'Finder':
                ...
                save_xml_param_to_file_on_run(
                    current_config_folder+'/finder_input.xml', 'n_prop_min', str(param_ligka['min_n_tor']))
                update_xml_param_on_run(
